...
1. [Infrastructure-as-Code (IaC) & Secret Scanning](#infrastructure-as-code-iac-and-secret-scanning)  
2. [Container Image Scanning & Software Composition Analysis (SCA)](#container-image-scanning--sca)

### Infrastructure-as-Code (IaC) And Secret Scanning
...
2. [Cloud Infrastructure Entitlement Management (CIEM), Data Security Posture Management (DSPM) & Attack Surface Management](#ciem-dspm--attack-surface-management)  
...
### CIEM, DSPM, & Attack Surface Management
...
* Defining remediation requirements by environment and criticality (see details in section [IaC & Secret Scanning](#infrastructure-as-code-iac--secret-scanning))
